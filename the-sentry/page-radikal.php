...
$imagen = attachment_image_url($post->ID, 'full'); ?>	
	<div class="container-fluid video">
		<div class="bg-video background-image" style="background: url('<?php echo $imagen; ?>')">

		</div>
		<div class="layer-video"></div>
		<div class="container video-logo">	
			<div class="row">
				<div class="text-right col-sm-6 col-md-offset-6">
					<img src="<?php echo THEMEPATH; ?>images/radikal.svg" alt="">
				</div>
			</div>
		</div>
	</div>
